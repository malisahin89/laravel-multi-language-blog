        ...
        <div class="bg-white p-6 shadow rounded-lg space-y-4">
            ...
            <div class="space-y-2">
                ...
                <div class="flex flex-wrap gap-2 border rounded-lg p-2">
                    @foreach ($tags as $tag)
                        <label class="flex items-center space-x-2 bg-gray-100 px-3 py-1 rounded-full hover:bg-blue-100 transition">
                            <input type="checkbox" name="tags[]" value="{{ $tag->id }}"
                                class="rounded text-blue-600 focus:ring-blue-500">
                            <span class="text-sm text-gray-700">{{ $tag->translations->where('language_slug', 'tr')->first()?->name }}</span>
                        </label>
                    @endforeach
                </div>
            </div>
                ...
                <div class="border border-gray-200 rounded-lg p-4 space-y-3 bg-gray-50">
                    ...
                    <div class="space-y-1">
                        ...
                        <textarea name="translations[{{ $lang->slug }}][content]"
                            ...
                            placeholder="Detaylı içerik"></textarea>
                    </div>
